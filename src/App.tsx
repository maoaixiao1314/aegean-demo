...
import ConsensusExecution from './pages/ConsensusExecution';
import { cn } from './lib/utils';

type Page = 'dashboard' | 'agent-stats' | 'create-group' | 'group-details' | 'consensus-execution' | 'risk';
...
export default function App() {
  ...
  const navItems = [
    ...
    { id: 'agent-stats', label: 'Agent Statistics', icon: Cpu, description: 'Global Performance' },
    { id: 'create-group', label: 'Group Orchestrator', icon: Users, description: 'Consensus Management' },
        ...
        <div className="flex-1 overflow-y-auto p-8 custom-scrollbar">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {activePage === 'agent-stats' && <AgentStats />}
              ...
              {activePage === 'group-details' && activeGroupId && (
                <GroupDetails 
                  groupId={activeGroupId} 
                  onExecuteConsensus={(groupId) => {
                    setActiveGroupId(groupId);
                    setActivePage('consensus-execution');
                  }}
                />
              )}
              {activePage === 'consensus-execution' && activeGroupId && (
                <ConsensusExecution groupId={activeGroupId} />
              )}
